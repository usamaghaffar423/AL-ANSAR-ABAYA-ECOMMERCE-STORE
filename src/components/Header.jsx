    ...
    return (
        <>
            <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ease-in-out`}>
                ...
                {/* ── Main Header ──────────────────────────────────── */}
                <div className={`transition-all duration-700 ease-in-out px-4 md:px-12 lg:px-16 bg-white border-b border-gray-200 ${isScrolled ? 'py-2 md:py-2.5 shadow-lg' : 'py-3 md:py-3.5'}`}>
