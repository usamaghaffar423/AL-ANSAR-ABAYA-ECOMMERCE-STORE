    ...
    return (
        ...
        >
            <div className="relative aspect-[3/4] overflow-hidden bg-gray-50 rounded-[24px] m-2">
                ...
                <div className="absolute left-4 top-5 flex flex-col gap-2 z-10 max-w-[70px]">
                    {product.is_trending && (
                        <div className="bg-black text-white px-2 py-1.5 rounded-full flex items-center justify-center gap-0.5 text-[9px] font-black uppercase tracking-widest whitespace-nowrap">
                            <Flame size={8} className="text-[#1a3a2a] flex-shrink-0" />
                            <span className="hidden sm:inline">Trending</span>
                        </div>
                    )}
                    {hasDiscount && (
                        <div className="bg-[#1a3a2a] text-white px-2 py-1.5 rounded-full flex items-center justify-center gap-0.5 text-[9px] font-black uppercase tracking-widest whitespace-nowrap">
                    ...
                    {isOutOfStock && (
                        <div className="bg-gray-800 text-white px-2 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest whitespace-nowrap flex items-center justify-center">
                            Out
                        </div>
                    )}
                </div>
