// API URL - Uses environment variable with fallback to Hostinger domain
const prodApiUrl = import.meta.env.VITE_API_URL || 'https://linen-bee-509910.hostingersite.com/api';
...
const prodImageUrl = import.meta.env.VITE_IMAGE_URL || 'https://linen-bee-509910.hostingersite.com/';
